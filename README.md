...
<html lang="en-US">
  <head>
    <meta charset="utf-8" />
    <title>easrng.github.io | 500: Shit's fucked</title>
      ...
      <div id="cf-error-details" class="p-0">
        <header class="mx-auto pt-10 lg:pt-6 lg:px-8 w-240 lg:w-full mb-8">
          <h1 class="inline-block sm:block sm:mb-2 font-light text-60 lg:text-4xl text-black-dark leading-tight mr-2">
            <span class="inline-block">Shit's fucked</span>
            <span class="code-label">Error code 500</span>
          </h1>
          <div>There is no more information.</div>
          <div class="mt-3">
            <script>
              document.write(new Date().toISOString().replace("T", " ").slice(0, -5) + " UTC");
            </script>
          </div>
        </header>
          ...
          <div class="w-240 lg:w-full mx-auto">
            <div class="clearfix md:px-8">
              ...
              <div id="cf-host-status" class="cf-error-source relative w-1/3 md:w-full py-15 md:p-0 md:py-8 md:text-left md:border-solid md:border-0 md:border-b md:border-gray-400 overflow-hidden float-left md:float-none text-center">
                ...
                <span class="md:block w-full truncate">easrng.github.io</span>
        ...
        <div class="w-240 lg:w-full mx-auto mb-8 lg:px-8">
          <div class="clearfix">
            ...
            <div class="w-1/2 md:w-full float-left leading-relaxed">
              ...
              <p class="mb-6">Please try to stay calm. Things will go back to normal soon, right? Right? Actually, when was "normal" even a thing anyway? Is there anything to return to?</p>
            </div>
          </div>
        </div>
        <div class="cf-error-footer cf-wrapper w-240 lg:w-full py-10 sm:py-4 sm:px-8 mx-auto text-center sm:text-left border-solid border-0 border-t border-gray-300">
          <p class="text-13">
            <span class="cf-footer-item sm:block sm:mb-1">
              Ray ID:
              <strong class="font-semibold">6e6f72657475726e</strong>
            </span>
            ...
            <span class="cf-footer-item sm:block sm:mb-1">
              <span>Performance &amp; security sounds like it was nice</span>
            </span>
          </p>
        </div>
      </div>
